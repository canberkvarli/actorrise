...
class EmailTemplates:
    ...
    def render_founder_offer_plain(self, user_name: str, intro_text: str = "", body_text: str = "", promo_code: str = "FOUNDER", upgrade_url: str = "actorrise.com/pricing", sender_name: str = "Canberk", sender_title: str = "Founder, ActorRise", **kwargs) -> str:
        ...
        lines = [
            f"hey {name},",
            "",
            "Welcome in. It's just me here, an actor building this for other actors, so it means a lot that you're trying it.",
            "",
            "I want you to have the good stuff, so here's 2 weeks of Plus, free. The AI scene partner reading with you, unlimited rehearsals, the whole thing. $0 today, just add a card to hold it, and it's $12/month after if you love it. Cancel in one click anytime before then.",
            "",
            "Start your 2 weeks free: https://actorrise.com/checkout?tier=plus&period=monthly&trial=1",
            "",
            "Put it on a real audition and tell me what works and what doesn't. I read every reply.",
            "",
            sender_name,
            "Founder, ActorRise",
            "actorrise.com",
