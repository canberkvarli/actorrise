...
on a clean tree with the change stashed, so it predates this work and is most
likely data drift from the 2026-08-19 film ingest (171d2fdd). Not investigated.
