...
export function ScenePartnerTutorial({ onComplete }: ScenePartnerTutorialProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-background/95 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="w-full max-w-md mx-4 flex flex-col items-center">
        ...
        <div className="min-h-[220px] w-full flex flex-col justify-center px-6 pt-12 pb-4">
