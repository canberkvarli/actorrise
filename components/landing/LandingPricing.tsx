        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8">
          {tiers.map((tier) => {
            ...
            return (
              <div
                key={tier.id}
                className="rounded-xl border border-border/60 p-8 flex flex-col relative bg-card/40"
              >
                <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight">{tier.display_name}</h3>
                {!isFree && (
