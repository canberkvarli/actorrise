...
export const metadata: Metadata = {
  ...
  description:
    "How to find an audition monologue that fits you: pick the length, tone, and type the room wants, skip the overdone ones, and search 8,500+ real pieces.",
  openGraph: {
    title: "How to Find a Monologue for an Audition | ActorRise",
    description:
      "The fast way to find an audition monologue that actually fits you: length, tone, type, and a searchable database of 8,500+ real pieces.",
  ...
  twitter: {
    ...
    title: "How to Find a Monologue for an Audition | ActorRise",
    description:
      "The fast way to find an audition monologue that actually fits you: length, tone, type, and 8,500+ real pieces.",
    ...
    <>
      ...
      <div className="container mx-auto px-6 py-12 md:py-16 max-w-2xl">
        ...
        <p className="text-muted-foreground mb-12">
          ...
          gender, and type, pulled from 8,500+ pieces across plays, film, and TV.
        </p>
