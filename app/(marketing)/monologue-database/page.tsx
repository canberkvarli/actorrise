...
const FAQ_ITEMS: { q: string; a: string; link?: { href: string; label: string } }[] = [
  {
    ...
    a: "Over 13,000 real monologues from plays, film, and TV, and it keeps growing. You can search all of it by tone, length, gender, and type.",
  },
  {
    ...
    <>
      ...
      <div className="container mx-auto px-6 py-12 md:py-16 max-w-2xl">
        ...
        <p className="text-muted-foreground mb-12">
          Over 13,000 real monologues, organized so you can actually find the right one: classical and
