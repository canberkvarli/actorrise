...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Audition monologues for every casting need. Classical, contemporary, comedic. 13,000+ pieces, AI search, Overdone filter.",
      ...
      <StageHero
        ...
        lede={
          <>
            ...
            search 13,000+ real pieces by style, length, gender, and tone. The AI finds what fits, so you
