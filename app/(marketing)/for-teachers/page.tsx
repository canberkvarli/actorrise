...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Find the right audition monologue in seconds. 19,000+ pieces, AI fit to type and casting, Overdone filter. We're starting with teachers and coaches; students spread it.",
