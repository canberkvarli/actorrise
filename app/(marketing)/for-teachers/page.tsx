...
export const metadata: Metadata = {
  ...
  description:
    "Your students find the right audition monologue in seconds. 8,500+ pieces, AI search, Overdone filter. A free resource for drama teachers.",
  openGraph: {
    title: "Monologues for Drama Teachers & Acting Coaches | ActorRise",
    description:
      "Find the right audition monologue in seconds. 8,500+ pieces, AI fit to type and casting, Overdone filter. We're starting with teachers and coaches; students spread it.",
  ...
  return (
    <>
      ...
      <p className="text-lg text-muted-foreground mb-8">
        ActorRise gives them 8,500+ searchable pieces, AI that matches to their type and the
      ...
      <ul className="space-y-3 text-muted-foreground mb-10">
        <li className="flex gap-2">
          ...
          <span>One of the largest searchable monologue databases (8,500+ pieces)</span>
        </li>
        <li className="flex gap-2">
          <span className="text-primary">·</span>
