...
export const metadata: Metadata = {
  ...
  description:
    "An AI rehearsal tool that reads the other lines so you can practice scenes and monologues before auditions. 13,000+ pieces. Free to try.",
  openGraph: {
    title: "AI Rehearsal Tool for Actors | ActorRise",
    description:
      "Practice scenes and monologues with AI that reads the other lines. 13,000+ monologues from plays, films, and TV. Free to try.",
    ...
    <>
      ...
      <ul className="space-y-3 text-muted-foreground mb-10">
        <li className="flex gap-2">
          ...
          <span>
            <strong className="text-foreground">Find material</strong>: search 13,000+ monologues and
      ...
      <section className="mt-16 border-t border-border pt-12">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Anything. Monologues and scenes from the 13,000+ piece database, your own sides or
