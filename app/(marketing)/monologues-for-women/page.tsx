...
export const metadata: Metadata = {
  ...
  description:
    "Monologues for women from 8,500+ real pieces. Comedic, dramatic, classical, contemporary. AI search by tone, length, age range, and type. Free to try.",
  openGraph: {
    title: "Monologues for Women | ActorRise",
    description:
      "Search 8,500+ monologues for women. Comedic, dramatic, classical, contemporary. AI-powered discovery.",
