...
export const metadata: Metadata = {
  ...
  description: "Monologues for teen actors and students. Search 19,000+ real pieces by age range, tone, and length to find audition and class material that fits.",
  openGraph: {
