...
export const metadata: Metadata = {
  ...
  description:
    "Find classical monologues from Shakespeare and beyond. 13,000+ searchable pieces with AI. Filter by play, length, and character type.",
  openGraph: {
    title: "Classical Monologues for Auditions | ActorRise",
    description:
      "Search 13,000+ monologues for classical pieces. Shakespeare and more. AI-powered discovery.",
