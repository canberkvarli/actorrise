...
export const metadata: Metadata = {
  ...
  description:
    "Find classical monologues from Shakespeare and beyond. 8,500+ searchable pieces with AI. Filter by play, length, and character type.",
  openGraph: {
    title: "Classical Monologues for Auditions | ActorRise",
    description:
      "Search 8,500+ monologues for classical pieces. Shakespeare and more. AI-powered discovery.",
