...
export const metadata: Metadata = {
  ...
  description: "Contemporary monologues for women from modern plays and screen. Search 13,000+ pieces by tone and length, skip the overdone ones, and walk in ready.",
  openGraph: {
