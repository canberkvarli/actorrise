...
export const metadata: Metadata = {
  ...
  description: "Two minute monologues for auditions. Search 19,000+ real pieces and filter by tone and type to find a strong two minute monologue that fits the call.",
  openGraph: {
