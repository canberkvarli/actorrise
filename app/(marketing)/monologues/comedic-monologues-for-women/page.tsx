...
export const metadata: Metadata = {
  ...
  description: "Find comedic monologues for women for auditions. Search 19,000+ real pieces by length and tone, filter out overdone choices, and land the laugh.",
  openGraph: {
...
const INTRO = "Comedy is hard to fake in an audition, so the piece has to fit you. Search 19,000+ real monologues by tone and length to find a comedic piece for a woman that actually lands, then filter out the ones casting hears every day.";
