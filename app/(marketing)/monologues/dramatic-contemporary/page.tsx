...
export const metadata: Metadata = {
  ...
  description:
    "Find dramatic monologues from contemporary plays in 8,500+ searchable pieces. AI search by era, tone, and length. Free to try.",
  openGraph: {
    title: "Dramatic Monologue from Contemporary Play | ActorRise",
    description:
      "Search 8,500+ monologues for dramatic pieces from contemporary plays. AI-powered discovery.",
