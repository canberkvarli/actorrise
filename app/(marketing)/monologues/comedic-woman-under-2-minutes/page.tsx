...
export const metadata: Metadata = {
  ...
  description:
    "Find comedic monologues for women under 2 minutes from 13,000+ pieces. AI search by length, type, and style. Free to try.",
  openGraph: {
    title: "Comedic Monologue for Woman Under 2 Minutes | ActorRise",
    description:
      "Search 13,000+ monologues for comedic pieces for women under 2 minutes. AI-powered, natural language search.",
