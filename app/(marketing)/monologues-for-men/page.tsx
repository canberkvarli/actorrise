...
export const metadata: Metadata = {
  ...
  description:
    "Monologues for men from 8,500+ real pieces. Comedic, dramatic, classical, contemporary. AI search by tone, length, age range, and type. Free to try.",
  openGraph: {
    title: "Monologues for Men | ActorRise",
    description:
      "Search 8,500+ monologues for men. Comedic, dramatic, classical, contemporary. AI-powered discovery.",
